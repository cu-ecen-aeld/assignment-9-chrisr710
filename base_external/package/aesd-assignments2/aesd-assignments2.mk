...
AESD_ASSIGNMENTS2_VERSION = 'ceaa90c'
# Note: Be sure to reference the *ssh* repository URL here (not https) to work properly
# with ssh keys and the automated build/test system.
# Your site should start with git@github.com:
AESD_ASSIGNMENTS2_SITE = 'git@github.com:cu-ecen-aeld/assignments-3-and-later-chrisr710.git'
AESD_ASSIGNMENTS2_SITE_METHOD = git
AESD_ASSIGNMENTS2_GIT_SUBMODULES = YES

define AESD_ASSIGNMENTS2_BUILD_CMDS
